...
export const useGalleryWorker = () => {
    ...
    // 高级任务方法
    const analyzeImageDimensions = useCallback(
        galleryData => {
    ...
    const calculatePaintingPositions = useCallback(
        data => {
    ...
    const generateFloorTextureData = useCallback(
        (config = {}) => {
    ...
    const generateCeilingTextureData = useCallback(
        (config = {}) => {
    ...
    const optimizeImagePaths = useCallback(
        imageList => {
    ...
    const batchProcessGalleryData = useCallback(
        data => {
