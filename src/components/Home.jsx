import EffectPixelDistortion from "./EffectPixelDistortion"; 
    ...
    return (
        <section className="flex flex-col lg:flex-row justify-center items-center gap-6 sm:gap-12 p-8 sm:p-12 md:p-24 lg:p-36 h-full z-1 fixed top-0 left-0 w-full">
            ...
            <div className="order-2 lg:order-1 text-white space-y-4 sm:space-y-6 text-center lg:text-left animate-slideIn">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold font-beauRivage mb-4 sm:mb-6">
                    Hua Wang
                </h1>
                <h2 className="text-2xl sm:text-3xl font-semibold mb-4 sm:mb-6 font-mono">
                    Software Engineer
                </h2>
            ...
            <div className="order-1 lg:order-2 animate-zoomIn">
                <div className="relative w-[200px] h-[200px] sm:w-[25vw] sm:h-[25vw] max-w-[500px] max-h-[500px] border-4 border-secondary rounded-full shadow-md overflow-hidden bg-light animate-hueRotate">
