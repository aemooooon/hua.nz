...
const ThemeLanguageToggle = () => {
    const { language, toggleLanguage, getText } = useAppStore();
    ...
    return (
        ...
        >
            ...
            <button
                ...
                title={`${getText('ui.language')}: ${language === 'en' ? 'English' : '中文'}`}
            >
            ...
            <button
                ...
                title={`${getText('ui.toggleTheme')}: ${currentThemeConfig.name[language] || currentThemeConfig.name.en}`}
            >
