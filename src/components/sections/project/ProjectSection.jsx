...
const ProjectSection = ({ language }) => {
    ...
    const filteredProjects =
        activeFilter === 'all' ? projects : projectsByCategory[activeFilter] || [];
                            ...
                            >
                                ...
                                <div className="project-image-container">
                                    ...
                                    {(project.links?.github ||
                                        ...
                                        >
                                            <svg
                                                className="w-4 h-4 text-theme-text-white"
                                                fill="currentColor"
                                                viewBox="0 0 24 24"
                                            >
                                    ...
                                    {/* 年份标签 - 右上角 */}
                                    <div
                                        className={`project-status-badge ${getStatusColor(project.year)}`}
                                    >
                                        {project.year || ''}
                                    </div>
                                </div>
