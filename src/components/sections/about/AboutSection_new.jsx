    ...
    return (
        <div className="min-h-screen w-full relative overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-stretch min-h-screen p-4 lg:p-6 xl:p-8">
                {/* 卡片区域 - 黄金分割的较大部分 (约62%) */}
                <div className="w-full lg:w-[62%] flex flex-col justify-center order-2 lg:order-1 lg:pr-4 xl:pr-6">
                    {/* 内容容器 - 内部也应用黄金比例的留白 */}
                    <div className="w-full max-w-none lg:max-w-[85%] xl:max-w-[80%] lg:ml-auto lg:mr-4 xl:mr-6">
                        {/* 增强毛玻璃背景卡片 */}
                ...
                {/* 头像区域 - 黄金分割的较小部分 (约38%) */}
                <div className="w-full lg:w-[38%] flex items-center justify-center mb-8 lg:mb-0 order-1 lg:order-2 lg:pl-4 xl:pl-6">
                    <div className="relative">
                        {/* 头像容器 - 圆形镜子外围绿色灯带效果 */}
                        <div className="w-72 h-72 sm:w-80 sm:h-80 lg:w-80 lg:h-80 xl:w-96 xl:h-96 relative rounded-full overflow-hidden bg-gray-900/50 backdrop-blur-sm border-4 border-green-300"
                             style={{
                                 filter: `
