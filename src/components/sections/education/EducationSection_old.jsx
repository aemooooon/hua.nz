        ...
        <>
            <div className="min-h-screen w-full p-4 sm:p-8 text-white flex items-center justify-center">
                <div className="max-w-7xl mx-auto w-full h-full">
                    ...
                    {/* 左右对称卡片容器 - 减少高度 */}
                    <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 h-[calc(100vh-300px)] max-h-[600px] max-w-7xl mx-auto py-8">
                        {/* 左侧卡片 - Masters */}
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {mastersDegree.capstoneProjects.map((project, index) => (
                                            <div
                                                key={index}
                                                className={`flex-1 project-thumbnail-card ${
                                            ...
                                            >
                                                <div
                                                    className="relative h-24 rounded-lg overflow-hidden group cursor-pointer project-image-container"
                                                    style={{
