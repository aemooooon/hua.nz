                                                    ...
                                                    <div className="text-center">
                                                        ...
                                                        <div className="flex flex-wrap justify-center gap-1">
                                                            {project.technologies.slice(0, 3).map((tech, techIdx) => (
                                                                <span key={techIdx} className="px-1 py-0.5 bg-emerald-500/20 text-emerald-300 text-xs rounded border border-emerald-500/30">
                                                                    {tech}
                                                                </span>
                                                            ))}
                                                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 bg-black/95 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center p-2">
                                                    <div className="text-center">
                                                        ...
                                                        <div className="flex flex-wrap justify-center gap-1">
                                                            {project.technologies.slice(0, 3).map((tech, techIdx) => (
                                                                <span key={techIdx} className="px-1 py-0.5 bg-blue-500/20 text-blue-300 text-xs rounded border border-blue-500/30">
                                                                    {tech}
                                                                </span>
                                                            ))}
                                                        </div>
