                ...
                <div className="min-h-screen w-full p-4 sm:p-8 text-white flex items-center justify-center">
                    <div className="max-w-6xl mx-auto w-full">
                        ...
                        <div className="grid gap-8 lg:gap-12">
                            ...
                            {/* 奖项区域 - 仅Bachelor页面显示 */}
                            {theme === "blue" && degree.awards && (
                                <div className={`bg-gradient-to-br from-yellow-500/10 to-orange-600/5 backdrop-blur-sm border border-yellow-400/20 rounded-3xl p-6 sm:p-8 shadow-2xl`}>
                                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-6 flex items-center">
