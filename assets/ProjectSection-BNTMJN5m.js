import{r as m,j as e,d as q}from"./react-DudRe3MH.js";import{P as p}from"./vendor-D2t9TNkl.js";import{L as v}from"./leaflet-BcfEFI1A.js";import{a as F,u as D,b as J}from"./index-E_q-5X86.js";import{G as R}from"./GlowDivider-DGRTBnis.js";import{T as H}from"./ThemeComponents-ncyhfpH0.js";import"./three-CFM8frH2.js";const E=({onClick:r,className:f="",ariaLabel:u="Close",iconSize:c="w-16 h-16",iconColor:d="text-theme-primary",iconHoverColor:M="text-white",circleColor:w="bg-theme-primary",circleSize:y="w-80 h-80",strokeWidth:L=1.2,animationDuration:a="duration-500",position:C={top:"top-8",right:"right-8"}})=>{const[g,b]=m.useState(!1),x={"w-10 h-10":{width:"2.5rem",height:"2.5rem"},"w-12 h-12":{width:"3rem",height:"3rem"},"w-16 h-16":{width:"4rem",height:"4rem"}},I={"w-24 h-24":{width:"6rem",height:"6rem"},"w-32 h-32":{width:"8rem",height:"8rem"},"w-80 h-80":{width:"20rem",height:"20rem"}},o={"bg-red-500":"#ef4444","bg-slate-800":"#1e293b","bg-theme-primary":"var(--theme-primary)","text-white":"#ffffff","text-red-400":"#f87171","text-theme-primary":"var(--theme-primary)"},h={"top-4":"1rem","top-6":"1.5rem","top-8":"2rem","right-4":"1rem","right-6":"1.5rem","right-8":"2rem"};return e.jsxs("div",{className:`fixed top-0 right-0 ${f} z-[100000]`,style:{width:"4rem",height:"4rem"},children:[e.jsx("div",{className:`absolute top-0 right-0 rounded-full transition-all ${a} ease-in-out ${g?"scale-100 opacity-100":"scale-50 opacity-0"} origin-top-right shadow-lg z-0`,style:{...I[y]||I["w-32 h-32"],backgroundColor:o[w]||o["bg-theme-primary"],transform:"translate(50%, -50%)"}}),e.jsx("button",{className:"absolute top-0 right-0 w-24 h-24 focus:outline-none z-20",onMouseEnter:()=>b(!0),onMouseLeave:()=>b(!1),onClick:k=>{k.preventDefault(),k.stopPropagation(),r()},"aria-label":u}),e.jsx("div",{className:"absolute pointer-events-none z-30",style:{top:h[C.top]||h["top-6"],right:h[C.right]||h["right-6"]},children:e.jsx("svg",{className:`transition-all ${a} ease-in-out drop-shadow-lg`,style:{...x[c]||x["w-12 h-12"],color:g?o[M]||o["text-white"]:o[d]||o["text-white"],transform:g?"scale(1.1)":"scale(1)"},fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",strokeWidth:L,children:e.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M6 18L18 6M6 6l12 12"})})})]})};E.propTypes={onClick:p.func.isRequired,className:p.string,ariaLabel:p.string,iconSize:p.string,iconColor:p.string,iconHoverColor:p.string,circleColor:p.string,circleSize:p.string,strokeWidth:p.number,animationDuration:p.string,position:p.shape({top:p.string,right:p.string})};delete v.Icon.Default.prototype._getIconUrl;v.Icon.Default.mergeOptions({iconRetinaUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon-2x.png",iconUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon.png",shadowUrl:"https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-shadow.png"});const G=({isOpen:r,onClose:f,language:u="en"})=>{const c=m.useRef(null),d=m.useRef(null),M=m.useRef([]),w=m.useRef(null),y=m.useRef(null),{getThemeColors:L}=F(),a=L(),{getAllLocations:C,getProjectsText:g}=D(),b=g(),x=m.useMemo(()=>C().filter(s=>s.type==="project"&&s.coordinates&&Array.isArray(s.coordinates)&&s.coordinates.length===2),[C]),I=m.useMemo(()=>({project:a.primary,work:a.success||"#10b981",education:a.warning||"#f59e0b",activity:a.purple||"#8b5cf6"}),[a]),o=m.useCallback(s=>typeof s=="object"&&s!==null?s[u]||s.en||s.zh||"":s||"",[u]),h=m.useCallback(s=>{if(!s||s.length===0)return[20,0];const l=s.length,t=s.reduce((n,z)=>n+z.coordinates[0],0),i=s.reduce((n,z)=>n+z.coordinates[1],0);return[t/l,i/l]},[]),k=m.useCallback(s=>{!d.current||!s||d.current.flyTo(s,12,{animate:!0,duration:1.5})},[]),$=m.useCallback(()=>v.divIcon({className:"custom-marker-icon",html:`<div class="marker-container" style="
      ...
      </div>`,iconSize:[40,40],iconAnchor:[20,20],popupAnchor:[0,-25]}),[]),Z=m.useCallback(s=>{const l=s.getChildCount();let t=50,i=16,n=70;return l>=100?(t=70,i=20,n=90):l>=10&&(t=60,i=18,n=80),v.divIcon({html:`<div class="cluster-container" style="
        width: ${n}px;
        height: ${n}px;
        position: relative;
        display: flex;
      ...
      ">
      ...
      </div>`,className:"custom-cluster-icon",iconSize:[n,n],iconAnchor:[n/2,n/2]})},[]),T=m.useCallback(()=>{if(!d.current)return;d.current.zoomControl.remove();const s=v.Control.extend({onAdd:function(t){const i=v.DomUtil.create("div","custom-map-controls");i.innerHTML=`
        ...
        `,v.DomEvent.disableClickPropagation(i),v.DomEvent.disableScrollPropagation(i);const n=i.querySelector(".zoom-in"),z=i.querySelector(".zoom-out"),N=i.querySelector(".reset-view"),j=i.querySelector(".locate-user");return n.addEventListener("click",()=>t.zoomIn()),z.addEventListener("click",()=>t.zoomOut()),N.addEventListener("click",()=>{if(x.length>0)if(x.length===1)t.setView(x[0].coordinates,10);else{const S=v.latLngBounds(x.map(B=>B.coordinates));t.fitBounds(S,{padding:[50,50]})}else{const S=h(x);t.setView(S,3)}}),j.addEventListener("click",()=>{navigator.geolocation&&(j.innerHTML=`
            ...
            `,navigator.geolocation.getCurrentPosition(S=>{const{latitude:B,longitude:A}=S.coords;t.setView([B,A],15);const Q=v.marker([B,A],{icon:v.divIcon({className:"user-location-marker",html:`<div style="
                ...
                `}))}),i}}),l=new s({position:"bottomright"});l.addTo(d.current),y.current=l},[u,x,h,b.map.resetToDefaultView]),W=m.useCallback(s=>{const l=o(s.title)||o(s.name),t=o(s.description),i=o(s.location),n=Array.isArray(s.img)?s.img[0]:s.img;return`
      <div style="
        color: #e5e7eb; 
    ...
    `},[o,a,u]);return m.useEffect(()=>{if(r&&c.current&&!d.current){const s=h(x);if(d.current=v.map(c.current,{zoomControl:!0,attributionControl:!0}).setView(s,3),v.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:"© OpenStreetMap contributors",minZoom:1,maxZoom:18}).addTo(d.current),T(),w.current=v.markerClusterGroup({iconCreateFunction:Z,maxClusterRadius:t=>t<=6?80:t<=10?50:t<=14?30:15,spiderfyOnMaxZoom:!0,showCoverageOnHover:!1,zoomToBoundsOnClick:!0,disableClusteringAtZoom:15,animate:!0,animateAddingMarkers:!0,spiderfyDistanceMultiplier:1.5,chunkedLoading:!0,removeOutsideVisibleBounds:!1}),x.forEach(t=>{const i=$(),n=v.marker(t.coordinates,{icon:i,title:o(t.title)||o(t.name)}),z=W(t);n.bindPopup(z,{maxWidth:800,minWidth:560,className:"custom-popup dark-popup",closeButton:!0,autoClose:!1,closeOnEscapeKey:!0,keepInView:!0,autoPan:!0,autoPanPadding:[20,20],offset:[0,-25]}),n.on("click",function(N){v.DomEvent.stopPropagation(N),n.openPopup(),setTimeout(()=>{k(t.coordinates)},100)}),n.on("mouseover",function(){n.bindTooltip(o(t.title)||o(t.name),{permanent:!1,direction:"top",offset:[0,-25],className:"marker-tooltip"}).openTooltip();const N=n.getElement();if(N){const j=N.querySelector("div");j&&(j.style.filter="brightness(1.2) contrast(1.1) drop-shadow(0 6px 16px rgba(0,0,0,0.5))",j.style.borderWidth="4px",j.style.boxShadow="0 6px 20px rgba(0,0,0,0.6), inset 0 3px 6px rgba(255,255,255,0.3)")}}),n.on("mouseout",function(){n.closeTooltip();const N=n.getElement();if(N){const j=N.querySelector("div");j&&(j.style.filter="",j.style.borderWidth="3px",j.style.boxShadow="0 4px 12px rgba(0,0,0,0.4), inset 0 2px 4px rgba(255,255,255,0.2)")}}),w.current.addLayer(n),M.current.push(n)}),d.current.addLayer(w.current),x.length>0)if(x.length===1)d.current.setView(x[0].coordinates,10);else{const t=v.latLngBounds(x.map(i=>i.coordinates));d.current.fitBounds(t,{padding:[50,50]})}const l=document.createElement("style");l.textContent=`
        /* 深色弹窗样式 - 简化覆盖策略 */
