const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home-DGaxs7SC.js","assets/react-N-_5-tx-.js","assets/vendor-RxfllKF0.js","assets/d3-BbFmVfHF.js","assets/vendor-DSulWsr7.css","assets/about-s3XgBEra.js","assets/three-CFp4aWDs.js","assets/gsap-CH_iu5NA.js","assets/texture-system-Cjw_EE1G.js","assets/gallery-CE8oZupf.js","assets/home-CFO6Tio1.css","assets/projects-BadiGN-f.js","assets/leaflet-BCigXWF9.js","assets/leaflet-BTrKGrB8.css","assets/projects-B3BEbutr.css","assets/EducationSection-C833fdOG.js","assets/EducationSection-DUw_6Q_9.css","assets/ContactSection-uR482WvE.js","assets/ContactSection-B2ZxASnB.css"])))=>i.map(i=>d[i]);
import{r as n,j as i,R as rt,d as ot}from"./react-N-_5-tx-.js";import{u as be,_ as xe}from"./about-s3XgBEra.js";import{P as X,l as nt,e as at}from"./vendor-RxfllKF0.js";import{w as J,u as Ue}from"./home-DGaxs7SC.js";import{E as ct,h as Pe,o as lt,H as Ve,M as je,W as Re,c as N,i as Fe,I as ht,J as dt,U as ut,K as ze,Q as mt,X as Be,x as Ne,Y as Le,Z as ft,A as $e,v as De,P as Se,_ as pt,$ as gt,a0 as Oe,u as Ee,a1 as We,s as Ye,a2 as qe,a3 as He,a4 as Xe,a5 as Je,a6 as vt,a7 as Ge,D as wt}from"./three-CFp4aWDs.js";import{P as bt}from"./gallery-CE8oZupf.js";import{t as xt}from"./texture-system-Cjw_EE1G.js";import"./d3-BbFmVfHF.js";import"./gsap-CH_iu5NA.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&r(c)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();class yt{constructor(e,t={},r="BackgroundCanvas"){if(this.canvas=e,this.componentId=r,this.componentId=r,this.gl=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl"),!this.gl)throw console.error("EffectFuse: Unable to get WebGL context"),new Error("WebGL not supported");this.resourceId=J.registerResources(this.componentId,{gl:this.gl,canvas:this.canvas},{persistent:!0}),this.params={brightness:1.8,blobiness:1.3,particles:16,scanlines:!1,energy:1.25,timeScale:1.1,...t},this.program=null,this.animationFrameId=null,this.startTime=performance.now(),this.uniformLocations={},this.themeColors=this.getThemeColors();try{this.initGL()}catch(s){throw console.error("EffectFuse: Failed to initialize WebGL",s),s}}initGL(){if(!this.gl){console.error("WebGL not supported.");return}this.gl.viewport(0,0,this.canvas.width,this.canvas.height),this.gl.getExtension("OES_texture_float");const e=`
            #ifdef GL_ES
