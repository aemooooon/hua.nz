const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home-DnVHr2u0.js","assets/react-N-_5-tx-.js","assets/vendor-RxfllKF0.js","assets/d3-BbFmVfHF.js","assets/vendor-DSulWsr7.css","assets/about-BltR6oax.js","assets/three-Br820KFa.js","assets/gsap-CH_iu5NA.js","assets/texture-system-RQf8gtA6.js","assets/gallery-JkPEW2ai.js","assets/home-DklKxYxB.css","assets/projects-BFe5SS-X.js","assets/leaflet-BCigXWF9.js","assets/leaflet-BTrKGrB8.css","assets/projects-B3BEbutr.css","assets/EducationSection-D7fnz23P.js","assets/EducationSection-Co46vkHx.css","assets/ContactSection-KrUWft8C.js","assets/ContactSection-B2ZxASnB.css"])))=>i.map(i=>d[i]);
import{r as n,j as s,R as et,d as tt}from"./react-N-_5-tx-.js";import{u as be,_ as ge}from"./about-BltR6oax.js";import{P as Z,l as st,e as rt}from"./vendor-RxfllKF0.js";import{w as K,u as Oe}from"./home-DnVHr2u0.js";import{I as it,h as Me,o as ot,J as He,M as Le,W as Te,c as A,i as Be,K as nt,Q as at,U as lt,X as Ne,Y as ct,Z as _e,_ as Ae,$ as je,a0 as ht,A as Ge,v as Ie,P as ve,a1 as dt,a2 as ut,a3 as ze,u as we,a4 as De,s as Ue,a5 as Ve,a6 as Fe,a7 as Ye,a8 as $e,a9 as mt,aa as We,D as ft}from"./three-Br820KFa.js";import{P as pt}from"./gallery-JkPEW2ai.js";import{t as gt}from"./texture-system-RQf8gtA6.js";import"./d3-BbFmVfHF.js";import"./gsap-CH_iu5NA.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const h of o.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&i(h)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();class vt{constructor(e,t={},i="BackgroundCanvas"){if(this.canvas=e,this.componentId=i,this.componentId=i,this.gl=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl"),!this.gl)throw console.error("EffectFuse: Unable to get WebGL context"),new Error("WebGL not supported");this.resourceId=K.registerResources(this.componentId,{gl:this.gl,canvas:this.canvas},{persistent:!0}),this.params={brightness:1.8,blobiness:1.3,particles:16,scanlines:!1,energy:1.25,timeScale:1.1,...t},this.program=null,this.animationFrameId=null,this.startTime=performance.now(),this.uniformLocations={},this.themeColors=this.getThemeColors();try{this.initGL()}catch(r){throw console.error("EffectFuse: Failed to initialize WebGL",r),r}}initGL(){if(!this.gl){console.error("WebGL not supported.");return}this.gl.viewport(0,0,this.canvas.width,this.canvas.height),this.gl.getExtension("OES_texture_float");const e=`
            #ifdef GL_ES
