const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home-DTMvYPbH.js","assets/react-N-_5-tx-.js","assets/vendor-RxfllKF0.js","assets/d3-BbFmVfHF.js","assets/vendor-DSulWsr7.css","assets/about-EC6mpzfQ.js","assets/gallery-DjhncEqu.js","assets/three-CFp4aWDs.js","assets/texture-system-Bm3WQeK3.js","assets/gsap-CH_iu5NA.js","assets/home-CGmMaHBT.css","assets/projects-Cx_mmpF_.js","assets/leaflet-BCigXWF9.js","assets/leaflet-BTrKGrB8.css","assets/projects-B3BEbutr.css","assets/EducationSection-CGz4ba2E.js","assets/EducationSection-DUw_6Q_9.css","assets/ContactSection-Cl573_7a.js","assets/ContactSection-B2ZxASnB.css"])))=>i.map(i=>d[i]);
var ht=Object.defineProperty;var dt=(a,e,t)=>e in a?ht(a,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):a[e]=t;var Ue=(a,e,t)=>dt(a,typeof e!="symbol"?e+"":e,t);import{r as n,j as i,R as Ye,d as ut}from"./react-N-_5-tx-.js";import{u as he,_ as pe,a as qe}from"./about-EC6mpzfQ.js";import{P as $,l as mt,e as ft}from"./vendor-RxfllKF0.js";import{w as Z}from"./home-DTMvYPbH.js";import{E as pt,h as ke,o as gt,H as Xe,M as Te,W as Me,c as D,i as Ae,I as wt,J as vt,U as bt,K as We,Q as xt,X as Fe,x as _e,Y as Ee,Z as yt,A as Je,v as Oe,P as ye,_ as Ct,$ as St,a0 as Ge,u as Ce,a1 as $e,s as Ke,a2 as Ze,a3 as Ve,a4 as Qe,a5 as et,a6 as Et,a7 as He,D as tt}from"./three-CFp4aWDs.js";import{P as Tt}from"./gallery-DjhncEqu.js";import{t as kt}from"./texture-system-Bm3WQeK3.js";import"./d3-BbFmVfHF.js";import"./gsap-CH_iu5NA.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function t(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(r){if(r.ep)return;r.ep=!0;const o=t(r);fetch(r.href,o)}})();class Mt{constructor(e,t={},s="BackgroundCanvas"){if(this.canvas=e,this.componentId=s,this.componentId=s,this.gl=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl"),!this.gl)throw console.error("EffectFuse: Unable to get WebGL context"),new Error("WebGL not supported");this.resourceId=Z.registerResources(this.componentId,{gl:this.gl,canvas:this.canvas},{persistent:!0}),this.params={brightness:1.8,blobiness:1.3,particles:16,scanlines:!1,energy:1.25,timeScale:1.1,...t},this.program=null,this.animationFrameId=null,this.startTime=performance.now(),this.uniformLocations={},this.themeColors=this.getThemeColors();try{this.initGL()}catch(r){throw console.error("EffectFuse: Failed to initialize WebGL",r),r}}initGL(){if(!this.gl){console.error("WebGL not supported.");return}this.gl.viewport(0,0,this.canvas.width,this.canvas.height),this.gl.getExtension("OES_texture_float");const e=`
            #ifdef GL_ES
