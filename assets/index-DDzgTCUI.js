const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/home-u2NRysWP.js","assets/react-N-_5-tx-.js","assets/vendor-RxfllKF0.js","assets/d3-BbFmVfHF.js","assets/vendor-DSulWsr7.css","assets/about-Dy3foT_Q.js","assets/three-Br820KFa.js","assets/gsap-CH_iu5NA.js","assets/texture-system-CYf2Z9rq.js","assets/gallery-iiuR5797.js","assets/home-CFO6Tio1.css","assets/projects-B8XkYc_x.js","assets/leaflet-BCigXWF9.js","assets/leaflet-BTrKGrB8.css","assets/projects-B3BEbutr.css","assets/EducationSection-BR0L7Vke.js","assets/EducationSection-Co46vkHx.css","assets/ContactSection-Dwi0Iik-.js","assets/ContactSection-B2ZxASnB.css"])))=>i.map(i=>d[i]);
import{r as n,j as i,R as tt,d as st}from"./react-N-_5-tx-.js";import{u as be,_ as pe}from"./about-Dy3foT_Q.js";import{P as Q,l as it,e as rt}from"./vendor-RxfllKF0.js";import{w as ee,u as Ge}from"./home-u2NRysWP.js";import{I as ot,h as Ee,o as nt,J as Ue,M as Te,W as Le,c as I,i as De,K as at,Q as lt,U as ct,X as Ne,Y as ht,Z as Ae,_ as Ie,$ as ke,a0 as dt,A as Ve,v as Be,P as ve,a1 as ut,a2 as mt,a3 as Fe,u as we,a4 as Oe,s as $e,a5 as Ye,a6 as We,a7 as qe,a8 as Xe,a9 as ft,aa as He,D as pt}from"./three-Br820KFa.js";import{P as gt}from"./gallery-iiuR5797.js";import{t as vt}from"./texture-system-CYf2Z9rq.js";import"./d3-BbFmVfHF.js";import"./gsap-CH_iu5NA.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();class wt{constructor(e,t={},r="BackgroundCanvas"){if(this.canvas=e,this.componentId=r,this.componentId=r,this.gl=this.canvas.getContext("webgl")||this.canvas.getContext("experimental-webgl"),!this.gl)throw console.error("EffectFuse: Unable to get WebGL context"),new Error("WebGL not supported");this.resourceId=ee.registerResources(this.componentId,{gl:this.gl,canvas:this.canvas},{persistent:!0}),this.params={brightness:1.8,blobiness:1.3,particles:16,scanlines:!1,energy:1.25,timeScale:1.1,...t},this.program=null,this.animationFrameId=null,this.startTime=performance.now(),this.uniformLocations={},this.themeColors=this.getThemeColors();try{this.initGL()}catch(s){throw console.error("EffectFuse: Failed to initialize WebGL",s),s}}initGL(){if(!this.gl){console.error("WebGL not supported.");return}this.gl.viewport(0,0,this.canvas.width,this.canvas.height),this.gl.getExtension("OES_texture_float");const e=`
            #ifdef GL_ES
